                    ...
                    Box(modifier = Modifier.padding(innerPadding)) {
                        ...
                        NavHost(navController, startDestination = ConnectRoute) {
                            ...
                            composable<ConnectRoute> {
                                ConnectScreen { _, _ ->
                                    val url = "wss://jarvis-yk4vgwmt.livekit.cloud"
                                    val token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NTUzNDExMjEsImlkZW50aXR5IjoidGVzdF91c2VyIiwiaXNzIjoiQVBJTGtqTTlQaUY2ZkE1IiwibmFtZSI6InRlc3RfdXNlciIsIm5iZiI6MTc1NTI1NDcyMSwic3ViIjoidGVzdF91c2VyIiwidmlkZW8iOnsicm9vbSI6InRlc3Rfcm9vbSIsInJvb21Kb2luIjp0cnVlfX0.p14yrcihwF4Yn0T_qFPcFgB4evudJiC14AUkIxzJ4tY"
                                    runOnUiThread {
